...
function startChat()
{	
	var wsUri = "ws://"+window.location.hostname+":10000/config/chat/server.php/?id=27"; 		// var wsUri = "ws://192.168.1.169:10000/Chat/server.php";
	websocket = new WebSocket(wsUri);

	//websocket.onconnecting = function(ev){	alert("connecting..."); }
	...
	{	console.log(ev.data);		//alert(ev.data);		
