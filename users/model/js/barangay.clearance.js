...
{	
	...
	{	
		...
		$.post('model/tbl.barangay.clearance.php',{token:"0",fb:"27",ft:"0",uLike:plParent.find(".tblSearch").val(),sort:_sortFilter(plParent),page:_pagiFilter(plParent)},function(json, status, xhr)
		{		
			$.each(json,function(i, v)
			{
				...
				{	
					...
					'<div class="tblRow t-row" id="tblRow_'+v.id+'">'+
						...
						'</div>'+tmpNav_lbl+
						'<div class="t-colb">'+
							'<div class="t-col  bc-a"><div class="cTitle t-val"><b>Type: </b>'+tmpDType+'</div> </div>'+
							'<div class="t-col  bc-b"><div class="cTitle t-val"><b>Date Issued: </b>'+fromDbDate(v.date_issued)+'</div> </div>'+
							'<div class="t-col  bc-c"><div class="cTitle t-val"><b>Purpose: </b>'+v.purpose+'</div> </div>'+
							'<div class="t-colz bc-d"><div class="cTitle t-val"><b>Remarks: </b>'+((v.remarks)?v.remarks+"<br/>":"")+((v.remarks_admin)?"Admin: "+v.remarks_admin:"")+'</div> </div>'+
						'</div>'+
					'</div>';
