...
<div class="tblFilter_wrap page-loaded">
	...
	<div class="dTable t-frame" id="dTable" >
		<div class="t-body">
			<div class="t-header">
				<div class="t-title" > <i class="fa fa-bullhorn"></i><p class="table-title">Breaking News</p> </div>
				<div class="t-navbars">
			...
			<div class="t-head">
				<div class="t-cola">
					...
					<div class="t-col-name" title="Title"> <div d-sort="0" class="tblHdr t-h-val">Title</div><u class="t-h-ico"></u> </div>
				</div>
				<div class="t-colb">
					<div class="t-col  bn-a" title="Date"> 		 <div d-sort="1" class="tblHdr t-h-val">Date</div><u class="t-h-ico"></u> </div>
					<div class="t-colz bn-b" title="Description"><div d-sort="2" class="tblHdr t-h-val">Description</div><u class="t-h-ico"></u> </div>
				</div>
			</div>
		...
		<div class="t-footer">
			...
			{
				echo '
				<button class="bnAdd_btn t-btn"><i class="fa fa-plus-circle"></i>Add</button>
				<button class="bnEdt_btn t-btn aTbl_btn" disabled ><i class="fa fa-pencil"></i>Edit</button>
				<button class="bnDel_btn t-btn aTbl_btn" disabled ><i class="fa fa-trash"></i>Delete</button>
				';
				$tblMAdd_btn = '<div class="bnAdd_btn t-m-navbar"><i class="fa fa-plus-circle"></i>Add New Record</div>';
				$tblMNavi_btn='
				...
				<label for="t-m-nava" class="t-f-m-nava">
					<div class="t-m-nava-fr">
						<div class="bnEdt_btn aTbl_btn t-m-navbar"><i class="fa fa-pencil"></i>Edit Record</div>
						<div class="bnDel_btn aTbl_btn t-m-navbar"><i class="fa fa-trash" ></i>Delete Record</div>
					</div>
				</label>
				';
				echo '<script class="appAScript_">(function(){loadScript_("model/js/admin/adm.breaking.news.js","a");})();</script>';
			}
			?>				
			</div>
			<!-- Admin Level -->
...
<script class="appScript_" type="text/javascript"> (function(){ loadScript_("model/js/breaking.news.js"); })(); </script> 
