...
<div class="tblFilter_wrap page-loaded">
	...
	<div class="dTable t-frame" id="dTable" >
		<div class="t-body">
			<div class="t-header">
				<div class="t-title" > <i class="fa fa-file"></i><p class="table-title">Items To BID</p> </div>
				<div class="t-navbars">
			...
			<div class="t-head">
				<div class="t-cola">
					...
					<div class="t-col-name" title="Contact Name"> <div d-sort="0" class="tblHdr t-h-val">Contract Name</div><u class="t-h-ico"></u> </div>
				</div>
				<div class="t-colb">
					<div class="t-col  itb-a" title="Ref. No."><div d-sort="1" class="tblHdr t-h-val c">Ref. No.</div><u class="t-h-ico"></u> </div>
					<div class="t-col  itb-b" title="ABC"><div d-sort="2" class="tblHdr t-h-val c">ABC</div><u class="t-h-ico"></u> </div>
					<div class="t-col  itb-c" title="Acceptance of Letter of Intent"><div d-sort="3" class="tblHdr t-h-val">Acceptance</div><u class="t-h-ico"></u> </div>
					<div class="t-col  itb-d" title="Pre-BID Conference"><div d-sort="4" class="tblHdr t-h-val">Pre-BID</div><u class="t-h-ico"></u> </div>
					<div class="t-colz itb-e" title="Opening of BIDS">	 <div d-sort="5" class="tblHdr t-h-val">Opening</div><u class="t-h-ico"></u> </div>
				</div>
			</div>
		...
		<div class="t-footer">
			...
			{
				echo '
				<button class="itbAdd_btn t-btn"><i class="fa fa-plus-circle"></i>Add</button>
				<button class="itbEdt_btn t-btn aTbl_btn" disabled ><i class="fa fa-pencil"></i>Edit</button>
				<button class="itbDel_btn t-btn aTbl_btn" disabled ><i class="fa fa-trash"></i>Delete</button>
				';
				$tblMAdd_btn = '<div class="itbAdd_btn t-m-navbar"><i class="fa fa-plus-circle"></i>Add New Record</div>';
				$tblMNavi_btn='
				...
				<label for="t-m-nava" class="t-f-m-nava">
					<div class="t-m-nava-fr">
						<div class="itbEdt_btn aTbl_btn t-m-navbar"><i class="fa fa-pencil"></i>Edit Record</div>
						<div class="itbDel_btn aTbl_btn t-m-navbar"><i class="fa fa-trash" ></i>Delete Record</div>
					</div>
				</label>
				';
				echo '<script class="appAScript_">(function(){loadScript_("model/js/admin/adm.items.to.bid.js","a");})();</script>';
			}
			?>				
			</div>
			<!-- Admin Level -->
...
<script class="appScript_" type="text/javascript"> (function(){ loadScript_("model/js/items.to.bid.js"); })(); </script> 
