...
<div class="tblFilter_wrap page-loaded">
	...
	<div class="dTable t-frame" id="dTable" >
		<div class="t-body">
			<div class="t-header">
				<div class="t-title" > <i class="fa fa-address-book"></i><p class="table-title">Directory</p> </div>
				<div class="t-navbars">
			...
			<div class="t-head">
				<div class="t-cola">
					...
					<div class="t-col-name" title="Office / Deparment"> <div d-sort="0" class="tblHdr t-h-val">Name/ Office/ Department</div><u class="t-h-ico"></u> </div>
				</div>
				<div class="t-colb">
					<div class="t-col  dir-a" title="Contact No."	><div d-sort="1" class="tblHdr t-h-val">Contact No.</div><u class="t-h-ico"></u> </div>
					<div class="t-col  dir-b" title="E-mail Address"><div d-sort="2" class="tblHdr t-h-val">E-mail</div><u class="t-h-ico"></u> </div>
					<div class="t-colz dir-c" title="Office Address"><div d-sort="3" class="tblHdr t-h-val">Office Address</div><u class="t-h-ico"></u> </div>
				</div>
			</div>
		...
		<div class="t-footer">
			...
			{
				echo '
				<button class="dirAdd_btn t-btn"><i class="fa fa-plus-circle"></i>Add</button>
				<button class="dirEdt_btn t-btn aTbl_btn" disabled ><i class="fa fa-pencil"></i>Edit</button>
				<button class="dirDel_btn t-btn aTbl_btn" disabled ><i class="fa fa-trash"></i>Delete</button>
				';
				$tblMAdd_btn = '<div class="dirAdd_btn t-m-navbar"><i class="fa fa-plus-circle"></i>Add New Record</div>';
				$tblMNavi_btn='
				...
				<label for="t-m-nava" class="t-f-m-nava">
					<div class="t-m-nava-fr">
						<div class="dirEdt_btn aTbl_btn t-m-navbar"><i class="fa fa-pencil"></i>Edit Record</div>
						<div class="dirDel_btn aTbl_btn t-m-navbar"><i class="fa fa-trash" ></i>Delete Record</div>
					</div>
				</label>
				';
				echo '<script class="appAScript_">(function(){loadScript_("model/js/admin/adm.directory.js","a");})();</script>';
			}
			?>				
			</div>
			<!-- Admin Level -->
...
<script class="appScript_" type="text/javascript"> (function(){ loadScript_("model/js/directory.js"); })(); </script> 
