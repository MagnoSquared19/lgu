...
<div class="page-loaded">
	<div class="page-panel"><div class="page-table" >
		<div class="dTable t-frame" id="dTable">
			<div class="t-body">
				<div class="t-header">
					<div class="t-title" > <i class="fa fa-users"></i><p class="table-title">Manage Users</p> </div>
					<div class="t-navbars">
						...
						<div class="t-navbar-fr">
							...
							<select tabindex="0" class="tblNumRows_sel t-hdr-sel" title="No. of Rows">
								...
								<option id="2" selected>15</option>
				...
				<div class="t-head">
					<div class="t-cola">
						...
						<div class="t-col-name"> <div d-sort="0" class="tblHdr t-h-val">Full Name</div><u class="t-h-ico"></u> </div>
					</div>
					<div class="t-colb">
						<div class="t-col user-a"  ><div d-sort="1" class="tblHdr t-h-val">Position</div><u class="t-h-ico"></u> </div>
						<div class="t-col user-b"  ><div d-sort="2" class="tblHdr t-h-val">Level</div><u class="t-h-ico"></u> </div>
						<div class="t-col user-c"  ><div d-sort="3" class="tblHdr t-h-val">Mobile No.</div><u class="t-h-ico"></u> </div>
						<div class="t-colz user-d" ><div d-sort="4" class="tblHdr t-h-val">E-mail</div><u class="t-h-ico"></u> </div>
					</div>
				</div>
			...
			<div class="t-footer">
				...
				{
					echo '
					<button class="uAdd_btn t-btn"><i class="fa fa-plus-circle"></i>Add</button>
					<button class="uEdt_btn t-btn aTbl_btn" disabled ><i class="fa fa-pencil"></i>Edit</button>
					<button class="uDel_btn t-btn aTbl_btn" disabled ><i class="fa fa-trash"></i>Delete</button>
					';
					$tblMAdd_btn = '<div class="uAdd_btn t-m-navbar"><i class="fa fa-plus-circle"></i>Add New Record</div>';
					$tblMNavi_btn='
					...
					<label for="t-m-nava" class="t-f-m-nava">
						<div class="t-m-nava-fr">
							<div class="uEdt_btn aTbl_btn t-m-navbar"><i class="fa fa-pencil"></i>Edit Record</div>
							<div class="uDel_btn aTbl_btn t-m-navbar"><i class="fa fa-trash"	></i>Delete Record</div>
						</div>
					</label>
					';
					echo '<script class="appAScript_">(function(){loadScript_("model/js/admin/adm.users.js","a");})();</script>';
				}
				?>					
				</div>
				<!-- Admin Level -->
...
<script class="appScript_" type="text/javascript"> (function(){ loadScript_("model/js/users.js"); })(); </script> 
