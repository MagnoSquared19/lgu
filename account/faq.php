...
if(intval($glevel)<=2)
{
	...
	$patBtn_b= '<div class="panel2-title-btn"><button class="patAdd_btn btnX ui-add-btn"><i class="fa fa-plus-circle"></i><u>Add</u></button></div>';
	echo '<script class="appAScript_">(function(){loadScript_("model/js/admin/adm.faq.js","a");})();</script>'; 
}
?>

	<div class="panel-left">
		<div class="panel2-title <?php echo $patBtn_p; ?>">
			<div class="panel2-title-val"><b>CALENDAR OF ACTIVITIES</b><p> - Upcoming and Previous Activities</p></div>			
			<?php echo $patBtn_b; ?>
		</div>
		<!-- : -->
		<div class="page-menu">
			...
			<div class="page-menu-body">
				...
				<div class="page-menu-filsort">
					...
					<div class="page-menu-sort"> <button class="pageSort_ftr pageAsc ui-btn-ipt"><i class="fa fa-sort-alpha-desc fa-sort-alpha-asc"></i></button> </div>
				</div>
			</div>
		</div>
	...
	<div class="panel-left"><div class="faqPost_panel poster-post-panel"></div></div>


</div></div>

<script class="appScript_" type="text/javascript"> (function(){ loadScript_("model/js/faq.js"); })(); </script> 
