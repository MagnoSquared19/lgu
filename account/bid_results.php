...
<div class="tblFilter_wrap page-loaded">
	...
	<div class="dTable t-frame" id="dTable" >
		<div class="t-body">
			<div class="t-header">
				<div class="t-title" > <i class="fa fa-file"></i><p class="table-title">BID Results</p> </div>
				<div class="t-navbars">
			...
			<div class="t-head">
				<div class="t-cola">
					...
					<div class="t-col-name" title="Contract Name"> <div d-sort="0" class="tblHdr t-h-val">Contract Name</div><u class="t-h-ico"></u> </div>
				</div>
				<div class="t-colb">
					<div class="t-col  br-a" title="Ref. No."	><div d-sort="1" class="tblHdr t-h-val c">Ref. No.</div><u class="t-h-ico"></u> </div>
					<div class="t-col  br-b" title="Amount"		><div d-sort="2" class="tblHdr t-h-val">Amount</div><u class="t-h-ico"></u> </div>
					<div class="t-col  br-c" title="Award Date"	><div d-sort="3" class="tblHdr t-h-val">Award D.</div><u class="t-h-ico"></u> </div>
					<div class="t-col  br-d" title="Proceed Date"><div d-sort="4" class="tblHdr t-h-val">Proc. D.</div><u class="t-h-ico"></u> </div>
					<div class="t-col  br-e" title="Reason for Award"><div d-sort="5" class="tblHdr t-h-val">R.F.A.</div><u class="t-h-ico"></u> </div>
					<div class="t-colz br-f" title="Awarded To"><div d-sort="6" class="tblHdr t-h-val">Award To</div><u class="t-h-ico"></u> </div>
				</div>
			</div>
		...
		<div class="t-footer">
			...
			{
				echo '
				<button class="brAdd_btn t-btn"><i class="fa fa-plus-circle"></i>Add</button>
				<button class="brEdt_btn t-btn aTbl_btn" disabled ><i class="fa fa-pencil"></i>Edit</button>
				<button class="brDel_btn t-btn aTbl_btn" disabled ><i class="fa fa-trash"></i>Delete</button>
				';
				$tblMAdd_btn = '<div class="brAdd_btn t-m-navbar"><i class="fa fa-plus-circle"></i>Add New Record</div>';
				$tblMNavi_btn='
				...
				<label for="t-m-nava" class="t-f-m-nava">
					<div class="t-m-nava-fr">
						<div class="brEdt_btn aTbl_btn t-m-navbar"><i class="fa fa-pencil"></i>Edit Record</div>
						<div class="brDel_btn aTbl_btn t-m-navbar"><i class="fa fa-trash" ></i>Delete Record</div>
					</div>
				</label>
				';
				echo '<script class="appAScript_">(function(){loadScript_("model/js/admin/adm.bid.results.js","a");})();</script>';
			}
			?>				
			</div>
			<!-- Admin Level -->
...
<script class="appScript_" type="text/javascript"> (function(){ loadScript_("model/js/bid.results.js"); })(); </script> 
