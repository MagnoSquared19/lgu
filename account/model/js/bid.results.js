...
{	
	if(pLoader_bool)
	{
		...
		$.post('model/tbl.bid.results.php',{token:"0",fb:"27",ft:"0",uLike:plParent.find(".tblSearch").val(),sort:_sortFilter(plParent),page:_pagiFilter(plParent),dFr:plParent.find(".tblFr_ipt").val(),dTo:plParent.find(".tblTo_ipt").val()},function(json, status, xhr)
		{		
			$.each(json,function(i, v)
			{
				...
				{	
					...
					'<div class="tblRow t-row" id="tblRow_'+v.id+'">'+
						...
						'</div>'+tmpNav_lbl+
						'<div class="t-colb">'+
							'<div class="t-col  br-a" ><div class="cTitle t-val break-word c"><b>Ref. No.: </b>'+v.ref_no+'</div> </div>'+
							'<div class="t-col  br-b" ><div class="cTitle t-val break-word txt-rp"><b>Amount: </b>'+toDecimal(v.amount)+'</div> </div>'+
							'<div class="t-col  br-c" ><div class="cTitle t-val break-word"><b>Award Date: </b>'+fromDbDate(v.award)+'</div> </div>'+
							'<div class="t-col  br-d" ><div class="cTitle t-val break-word"><b>Proceed Date: </b>'+fromDbDate(v.proceed)+'</div> </div>'+
							'<div class="t-col  br-e" ><div class="cTitle t-val break-word"><b>Reason for Award: </b>'+v.reason+'</div> </div>'+
							'<div class="t-colz br-f" ><div class="cTitle t-val"><b>Award To: </b>'+v.awarded_to+'</div> </div>'+
						'</div>'+
					'</div>';
